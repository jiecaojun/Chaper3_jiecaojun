...
public class MainActivity extends AppCompatActivity {
    ...
    private void resetTargetAnimation() {
        ...
        ObjectAnimator animatorPractice1=ObjectAnimator.ofFloat(target, "scaleX",1,2);
        animatorPractice1.setDuration(Integer.parseInt(durationSelector.getText().toString()));
        animatorPractice1.setRepeatCount(ObjectAnimator.INFINITE);
        animatorPractice1.setRepeatMode(ObjectAnimator.REVERSE);
        ObjectAnimator animatorPractice2=ObjectAnimator.ofFloat(target, "scaleY",1,2);
        animatorPractice2.setDuration(Integer.parseInt(durationSelector.getText().toString()));
        animatorPractice2.setRepeatCount(ObjectAnimator.INFINITE);
        animatorPractice2.setRepeatMode(ObjectAnimator.REVERSE);

        // TODO 2：在这里实现另一个 ObjectAnimator，对 target 控件的透明度进行修改，从 1 到 0.5f 循环
        ObjectAnimator animatorPractice3 =ObjectAnimator.ofFloat(target,"alpha",1, (float)0.5);
        animatorPractice3.setDuration(Integer.parseInt(durationSelector.getText().toString()));
        animatorPractice3.setRepeatCount(ObjectAnimator.INFINITE);
        animatorPractice3.setRepeatMode(ObjectAnimator.REVERSE);

        // TODO 3: 将上面创建的其他 ObjectAnimator 都添加到 AnimatorSet 中
        animatorSet = new AnimatorSet();
        animatorSet.playTogether(animator1);
        animatorSet.playTogether(animatorPractice1,animatorPractice2,animatorPractice3);
        animatorSet.start();
    }
}
